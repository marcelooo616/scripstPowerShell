function Show-MainForm {
   ...
   # Calcular tamanho da janela (80% da tela)
   $formWidth = [int]($screenWidth * 0.31)
   ...
   # Configurações da janela principal
    ...
    $form.FormBorderStyle = [System.Windows.Forms.FormBorderStyle]::Sizable  # Permitir redimensionamento
    $form.MinimumSize = New-Object System.Drawing.Size(600, 760)
    ...
    $pictureBox.Size = New-Object System.Drawing.Size(200, 200) # Tamanho da imagem
    $pictureBox.Location = New-Object System.Drawing.Point(50, 500) # Posição à direita dos botões
    ...
    $textBox.Location = New-Object System.Drawing.Point(300, 500)
    $textBox.Font = New-Object System.Drawing.Font("Segoe UI", 10, [System.Drawing.FontStyle]::Bold)
 ...
 $form.Controls.Add($copyButton)
    ...
    $buttonExit.Location = New-Object System.Drawing.Point(450, 670)
